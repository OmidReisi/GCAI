...
#     best_moves = []
#     max_eval = -1000
#     turn_eval = -1 if turn_to_move == "b" else 1
#
#     if len(valid_moves) == 0:
#         return None
#
#     for move in valid_moves:
#
#         move_eval = turn_eval * get_move_evaluation(
#             board_state,
#             turn_to_move,
#             move,
#             king_pos,
...
# ) -> Move | None:
#     for move in valid_moves:
#         move_board_state = make_move(board_state,turn_to_move, move)
